...
GRANT SELECT, INSERT, UPDATE, INDEX, ALTER, SHOW VIEW, CREATE ROUTINE, ALTER ROUTINE ON *.* TO `usuario`@`localhost` IDENTIFIED BY PASSWORD '*AD77F56D2FD78299B87609DCC0423260B5AADB03';

GRANT SELECT, INSERT, UPDATE, INDEX, ALTER, SHOW VIEW, CREATE ROUTINE, ALTER ROUTINE ON `fiscal`.* TO `usuario`@`localhost`;
